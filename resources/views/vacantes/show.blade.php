...
@section('content')
<h1 class="text-3xl mt-10 text-center">{{ $vacante->titulo }}</h1>
<div class="mt-10 mb-20 md:flex items-start">
    <div class="md:w-3/5">
        ...
        <h2 class="text-2xl mt-10 text-center text-gray-700 mb-5">Conocimientos y Tecnologías</h2>
        @php
        $arraySkills = explode(',', $vacante->skills);
        @endphp
        @foreach ($arraySkills as $skill)
        <p class="inline-block border border-gray-500 py-2 px-8 rounded text-gray-700 font-bold my-2">
            {{ $skill }}
        </p>
        @endforeach
